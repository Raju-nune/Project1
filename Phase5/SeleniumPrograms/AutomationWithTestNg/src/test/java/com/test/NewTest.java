...
public void register() {
		...
		driver.findElement(By.name("customerName")).sendKeys("Raju");	
		driver.findElement(By.name("email")).sendKeys("rajudarling6607@gmail.com");
		driver.findElement(By.name("password")).sendKeys("Raju@123");
		driver.findElement(By.name("passwordCheck")).sendKeys("Raju@123");
